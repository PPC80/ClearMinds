package com.cobis.cloud.atm.aws.batch.procesos.b16203;
...
import com.cobiscorp.businesslogic.atm_his.BL_atm_paso_his_compensa;
...
class JobDefinitionTest {
	...
	void testGetBusinessLogicProgram(){
		...
		//Valor esperado
		IBusinessLogic iBusinessLogicExpected = new BL_atm_paso_his_compensa();
